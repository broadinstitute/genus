...
####        logit_expanded_ntb1wh = unet_output.logit.expand([self.n_mc_samples_for_temperature,
...
####        logp_ber_ntb = compute_logp_bernoulli(c=c_mcsamples_ntb1wh, logit=unet_output.logit).sum(dim=(-1, -2, -3))
####        with torch.no_grad():
